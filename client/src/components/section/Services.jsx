        ...
        <div className="flex flex-col items-center gap-y-80">
          ...
          >
            ...
            <p className="text-sm text-justify text-white">
              ...
              aesthetics and a deep understanding of user experience, I
              specialize in creating engaging online experiences that leave a
              lasting impression.
            </p>
          </motion.div>
          <motion.div
          ...
          <div className="grid grid-cols-3 items-center px-5">
            ...
            >
              ...
              <p className="text-sm text-justify text-white">
                ...
                seamlessly across different devices and screen sizes. With a
                deep understanding of responsive design principles, I specialize
                in crafting engaging online experiences that provide an optimal
                viewing and interaction experience for every user.
              </p>
            </motion.div>
            <div className="">
              <img src={rec} alt="rec image" className="mx-auto w-3/5 h-44" />
            </div>
            <motion.div
              initial={{ x: -330 }}
              whileInView={{ x: 0 }}
            ...
            >
              ...
              <p className="text-sm text-justify text-white">
                I am a meticulous and experienced website bug fixer, dedicated
                to identifying and resolving issues to ensure smooth and
                error-free functionality for your website. With a keen eye for
                detail and a strong troubleshooting mindset, I specialize in
                detecting and fixing bugs that may disrupt the user experience
                or hinder the performance of your website.
              </p>
            </motion.div>
          </div>
        </div>
