...
const Profile = () => {
  return (
    <div className="pb-6 border-b border-secondary/10 dark:border-slate-700">
      <Image
        src={myImage}
        width={112}
      ...
      <div className="flex items-center justify-center gap-x-3 text-neutral-200 mt-5">
        <a
          href="https://www.facebook.com/profile.php?id=100078261521721"
          target="_blank"
          rel="noreferrer"
          className="h-9 w-9 border border-neutral-500 flex justify-center items-center rounded-full duration-500 cursor-pointer hover:text-secondary dark:hover:text-purple-400 hover:border-secondary dark:hover:border-purple-400"
        >
          <BsFacebook size={15} />
        </a>
        <a
