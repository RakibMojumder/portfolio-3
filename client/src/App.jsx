...
function App() {
  ...
  return (
    <main className="min-h-screen w-full bg-black dark:bg-purple-gradient flex justify-center items-center">
      ...
      <div className="dark:bg-purple-200/[.07] bg-white/5 border dark:border-none border-emerald-500/10 sm:h-[90vh] sm:w-[93%] 2xl:w-[75%] 2xl:mx-auto rounded-xl overflow-hidden font-montserrat">
        <ThemeProvider>
